...
\fancyhead[R]{\small Cristiano Alves}
\fancyfoot[C]{\thepage}
...
\begin{document}
	...
	\textbf{Cristiano Alves} [inserir biografia resumida: titulação, experiência em química quântica computacional, docência e/ou pesquisa com pontos quânticos e PySCF, publicações relevantes, etc.].
	\vspace{1cm}
